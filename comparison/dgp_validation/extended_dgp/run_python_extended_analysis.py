"""Run Python pycausalarima Analysis on Extended DGPs."""
...
# Add parent directory for pycausalarima import
...
print("Running Python pycausalarima Extended Analysis...")
print("=" * 50)
print()
...
for dgp in dgps:
    ...
    print(f"  - True effect: {dgp['effect']:+.1f}")
    ...
    try:
        ...
        norm_results.to_csv(f"results_python/dgp_{dgp_id}_norm.csv", index=False)
        ...
        final_results.to_csv(f"results_python/dgp_{dgp_id}_final.csv", index=False)
...
print()
print("=" * 50)
print("Python Extended analysis complete!")
